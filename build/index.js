...
var _rychan14$resume$Types$SectionTitle = {ctor: 'SectionTitle'};
var _rychan14$resume$Types$Main = {ctor: 'Main'};
var _rychan14$resume$Types$None = {ctor: 'None'};

var _rychan14$resume$Resume_View$educationSection = {
	ctor: '::',
	_0: _mdgriffith$style_elements$Element$section(
		A3(
			_mdgriffith$style_elements$Element$column,
			_rychan14$resume$Types$None,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: A2(
					...
					A3(
						...
						_rychan14$resume$Types$None,
						{ctor: '[]'},
						_mdgriffith$style_elements$Element$text('Education'))),
				_1: {ctor: '[]'}
			})),
	_1: {ctor: '[]'}
};
var _rychan14$resume$Resume_View$skillsSection = {
	ctor: '::',
	_0: _mdgriffith$style_elements$Element$section(
		A3(
			_mdgriffith$style_elements$Element$column,
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					A3(
						...
						_rychan14$resume$Types$None,
						{ctor: '[]'},
						_mdgriffith$style_elements$Element$text('Skills'))),
				_1: {ctor: '[]'}
			})),
	_1: {ctor: '[]'}
};
var _rychan14$resume$Resume_View$experienceSection = {
	ctor: '::',
	_0: _mdgriffith$style_elements$Element$section(
		A3(
			_mdgriffith$style_elements$Element$column,
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					A3(
						_mdgriffith$style_elements$Element$el,
						_rychan14$resume$Types$SectionTitle,
						{ctor: '[]'},
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								A3(
									...
									{
										ctor: '::',
										_0: _mdgriffith$style_elements$Element$text('Mirum Agency, '),
										_1: {
											ctor: '::',
											_0: _mdgriffith$style_elements$Element$text('San Diego -- '),
											_1: {
												ctor: '::',
												_0: _mdgriffith$style_elements$Element$text('Web Developer'),
												_1: {ctor: '[]'}
											}
										}
									})),
							_1: {
								...
								_0: A3(
									...
									{
										ctor: '::',
										_0: _mdgriffith$style_elements$Element$text('August 2015 - Present'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									A3(
										...
										{
											ctor: '::',
											_0: _mdgriffith$style_elements$Element$text('BofI Federal Bank, '),
											_1: {
												ctor: '::',
												_0: _mdgriffith$style_elements$Element$text('San Diego -- '),
												_1: {
								...
								_1: {
									...
									_0: A3(
										...
										{
											ctor: '::',
											_0: _mdgriffith$style_elements$Element$text('September 2014 - August 2015'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
...
var _rychan14$resume$Resume_Styles$colors = {
	lightCyan: A4(_elm_lang$core$Color$rgba, 224, 255, 255, 1)
};
var _rychan14$resume$Resume_Styles$styles = A2(
	_mdgriffith$style_elements$Style$style,
	_rychan14$resume$Types$SectionTitle,
	{
		ctor: '::',
		_0: _mdgriffith$style_elements$Style_Color$text(_rychan14$resume$Resume_Styles$colors.lightCyan),
		_1: {ctor: '[]'}
	});

var _rychan14$resume$Styles$stylesheet = _mdgriffith$style_elements$Style$stylesheet(
	_elm_lang$core$List$concat(
		{
			ctor: '::',
			_0: {
				...
				_1: {
					...
					_0: A2(
						_mdgriffith$style_elements$Style$style,
						_rychan14$resume$Types$Main,
						{ctor: '[]'}),
					_1: {
						ctor: '::',
						_0: _rychan14$resume$Resume_Styles$styles,
						_1: {ctor: '[]'}
					}
				}
			},
...
var _rychan14$resume$App$view = function (model) {
	return A2(
		...
		_rychan14$resume$Styles$stylesheet,
		A4(
			_mdgriffith$style_elements$Element$grid,
			_rychan14$resume$Types$Main,
			{
				columns: {
					ctor: '::',
					_0: _mdgriffith$style_elements$Element_Attributes$fill(3),
					_1: {
						ctor: '::',
						_0: _mdgriffith$style_elements$Element_Attributes$fill(1),
						_1: {ctor: '[]'}
					}
				},
				rows: {
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					_rychan14$resume$Resume_View$view(model)),
				_1: {ctor: '[]'}
			}));
};
