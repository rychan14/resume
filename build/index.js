...
var _rychan14$resume$Colors$colors = {orange: 'rgb(255, 165, 0)', black: 'rgb(0, 0, 0)', marine: 'rgb(27, 43, 52)', white: 'rgb(255, 255, 255)', yellow: 'rgb(250, 200, 99)', blue: 'rgb(155, 194, 207)', red: 'rgb(236, 95, 103)'};
var _rychan14$resume$Colors$defaultTheme = {primary: _rychan14$resume$Colors$colors.white, secondary: _rychan14$resume$Colors$colors.marine, tertiary: _rychan14$resume$Colors$colors.orange, text: _rychan14$resume$Colors$colors.marine, title: _rychan14$resume$Colors$colors.blue};
var _rychan14$resume$Colors$themes = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: 'light',
			_1: {primary: _rychan14$resume$Colors$colors.white, secondary: _rychan14$resume$Colors$colors.marine, tertiary: _rychan14$resume$Colors$colors.orange, text: _rychan14$resume$Colors$colors.marine, title: _rychan14$resume$Colors$colors.blue}
		},
		_1: {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'dark',
				_1: {primary: _rychan14$resume$Colors$colors.marine, secondary: _rychan14$resume$Colors$colors.orange, tertiary: _rychan14$resume$Colors$colors.yellow, text: _rychan14$resume$Colors$colors.white, title: _rychan14$resume$Colors$colors.red}
			},
			_1: {ctor: '[]'}
		}
	});

var _rychan14$resume$App$concatStyles = function (styles) {
	return _elm_lang$html$Html_Attributes$style(
		_elm_lang$core$List$concat(styles));
};
var _rychan14$resume$App$buttonTheming = F2(
	function (themeType, msg) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Primary':
				return function (_) {
					...
					A2(
						...
						_rychan14$resume$Colors$defaultTheme,
						A2(
							_elm_lang$core$Dict$get,
							_elm_lang$core$String$toLower(themeType),
							_rychan14$resume$Colors$themes)));
			case 'Secondary':
				return function (_) {
					return _.secondary;
				}(
			...
			default:
				return function (_) {
					...
					A2(
						_elm_lang$core$Maybe$withDefault,
						_rychan14$resume$Colors$defaultTheme,
						A2(_elm_lang$core$Dict$get, themeType, _rychan14$resume$Colors$themes)));
		}
	});
var _rychan14$resume$App$theming = F2(
	function (model, msg) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'Primary':
				return function (_) {
					...
					A2(
						_elm_lang$core$Maybe$withDefault,
						_rychan14$resume$Colors$defaultTheme,
						A2(_elm_lang$core$Dict$get, model.theme, _rychan14$resume$Colors$themes)));
			case 'Secondary':
				return function (_) {
					return _.secondary;
				}(
...
var _rychan14$resume$App$bigOrSmall = F3(
	function (model, list1, list2) {
		return (_elm_lang$core$Native_Utils.cmp(model.width, 1100) > 0) ? list1 : list2;
	});
		...
		switch (_p2.ctor) {
			...
			case 'ResizeMsg':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{height: _p2._0.height, width: _p2._0.width}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ThemeMsg':
				var _p3 = _p2._0;
									...
									_0: _mdgriffith$elm_style_animation$Animation$to(
										{
											...
											_0: _mdgriffith$elm_style_animation$Animation$backgroundColor(
												_elm_lang$core$Native_Utils.eq(_p3, 'light') ? A3(_elm_lang$core$Color$rgb, 255, 255, 255) : A3(_elm_lang$core$Color$rgb, 27, 43, 52)),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								},
...
var _rychan14$resume$App_ops = _rychan14$resume$App_ops || {};
_rychan14$resume$App_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _rychan14$resume$App$boldText = {
	ctor: '::',
...
var _rychan14$resume$App$bulletPoint = {
	...
	_1: {
		ctor: '::',
		_0: A2(_rychan14$resume$App_ops['=>'], 'line-height', '24px'),
		_1: {
			ctor: '::',
			_0: A2(_rychan14$resume$App_ops['=>'], 'letter-spacing', '0'),
			_1: {
				ctor: '::',
				_0: A2(_rychan14$resume$App_ops['=>'], 'margin-left', '25px'),
				_1: {ctor: '[]'}
			}
		}
	}
};
var _rychan14$resume$App$inlineBlock = {
	ctor: '::',
	_0: A2(_rychan14$resume$App_ops['=>'], 'display', 'inline-block'),
	_1: {ctor: '[]'}
};
var _rychan14$resume$App$block = {
	ctor: '::',
	_0: A2(_rychan14$resume$App_ops['=>'], 'display', 'block'),
	_1: {ctor: '[]'}
};
var _rychan14$resume$App$contactInfo = A2(
		...
		_0: A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(_rychan14$resume$App$block),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _rychan14$resume$App$concatStyles(
										{
											ctor: '::',
											_0: _rychan14$resume$App$inlineBlock,
											_1: {
												ctor: '::',
												_0: _rychan14$resume$App$boldText,
												_1: {ctor: '[]'}
											}
										}),
									_1: {ctor: '[]'}
...
var _rychan14$resume$App$centerBlock = {
	ctor: '::',
	_0: A2(_rychan14$resume$App_ops['=>'], 'margin', '0 auto'),
	_1: {ctor: '[]'}
};
var _rychan14$resume$App$overflowEllip = {
	ctor: '::',
	_0: A2(_rychan14$resume$App_ops['=>'], 'overflow', 'hidden'),
	_1: {
		ctor: '::',
		_0: A2(_rychan14$resume$App_ops['=>'], 'text-overflow', 'ellipsis'),
		_1: {
			ctor: '::',
			_0: A2(_rychan14$resume$App_ops['=>'], 'white-space', 'nowrap'),
			_1: {ctor: '[]'}
		}
	}
};
var _rychan14$resume$App$name = {
	ctor: '::',
	_0: A2(_rychan14$resume$App_ops['=>'], 'font-size', '56px'),
	_1: {
		ctor: '::',
		_0: A2(_rychan14$resume$App_ops['=>'], 'line-height', '1.35'),
		_1: {
			ctor: '::',
			_0: A2(_rychan14$resume$App_ops['=>'], 'letter-spacing', '-.02em'),
			_1: {
				ctor: '::',
				_0: A2(_rychan14$resume$App_ops['=>'], 'margin', '0 0 24px 0'),
				_1: {ctor: '[]'}
			}
		}
	}
};
var _rychan14$resume$App$nameSection = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(_rychan14$resume$App$name),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Ryan Chan'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A3(
					_rychan14$resume$App$bigOrSmall,
					model,
					_elm_lang$html$Html$text(''),
					_rychan14$resume$App$contactInfo),
				_1: {ctor: '[]'}
			}
		});
};
var _rychan14$resume$App$buttonContainerStyle = {
	ctor: '::',
	_0: A2(_rychan14$resume$App_ops['=>'], 'display', 'grid'),
	_1: {
		ctor: '::',
		_0: A2(_rychan14$resume$App_ops['=>'], 'grid-template-columns', 'min-content min-content'),
		_1: {
			ctor: '::',
			_0: A2(_rychan14$resume$App_ops['=>'], 'grid-column-gap', '20px'),
			_1: {
				ctor: '::',
				_0: A2(_rychan14$resume$App_ops['=>'], 'margin-top', '15px'),
				_1: {ctor: '[]'}
			}
		}
	}
};
var _rychan14$resume$App$Model = F5(
	function (a, b, c, d, e) {
		return {code: a, height: b, width: c, theme: d, style: e};
	});
var _rychan14$resume$App$AnimateMsg = function (a) {
	return {ctor: 'AnimateMsg', _0: a};
};
var _rychan14$resume$App$ThemeMsg = function (a) {
	return {ctor: 'ThemeMsg', _0: a};
};
var _rychan14$resume$App$ResizeMsg = function (a) {
	return {ctor: 'ResizeMsg', _0: a};
};
var _rychan14$resume$App$getInitialWindowDimensions = A2(_elm_lang$core$Task$perform, _rychan14$resume$App$ResizeMsg, _elm_lang$window$Window$size);
var _rychan14$resume$App$init = {
	...
	_1: _rychan14$resume$App$getInitialWindowDimensions
};
var _rychan14$resume$App$KeyMsg = function (a) {
	return {ctor: 'KeyMsg', _0: a};
};
var _rychan14$resume$App$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$keyboard$Keyboard$downs(_rychan14$resume$App$KeyMsg),
			_1: {
				ctor: '::',
				_0: _elm_lang$window$Window$resizes(_rychan14$resume$App$ResizeMsg),
				_1: {
					ctor: '::',
					_0: A2(
						_mdgriffith$elm_style_animation$Animation$subscription,
						_rychan14$resume$App$AnimateMsg,
						{
							ctor: '::',
							_0: model.style,
							_1: {ctor: '[]'}
...
var _rychan14$resume$App$Text = {ctor: 'Text'};
var _rychan14$resume$App$Title = {ctor: 'Title'};
var _rychan14$resume$App$sectionTitle = function (model) {
	return {
		ctor: '::',
		_0: A2(
			_rychan14$resume$App_ops['=>'],
			'color',
			A2(_rychan14$resume$App$theming, model, _rychan14$resume$App$Title)),
		_1: {
			ctor: '::',
			_0: A2(_rychan14$resume$App_ops['=>'], 'font-size', '25px'),
			_1: {
				ctor: '::',
				_0: A2(_rychan14$resume$App_ops['=>'], 'line-height', '48px'),
				_1: {
					ctor: '::',
					_0: A2(_rychan14$resume$App_ops['=>'], 'margin', '0px'),
					_1: {ctor: '[]'}
				}
			}
		}
...
var _rychan14$resume$App$experienceSection = function (model) {
	return A2(
		_elm_lang$html$Html$section,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$h2,
				{
					...
					_0: function (_p4) {
						return _elm_lang$html$Html_Attributes$style(
							_rychan14$resume$App$sectionTitle(_p4));
					}(model),
					_1: {ctor: '[]'}
				},
				{
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Mirum Agency, '),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('San Diego -- '),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$span,
											{
												...
												_0: _elm_lang$html$Html_Attributes$style(
													{
														ctor: '::',
														_0: A2(_rychan14$resume$App_ops['=>'], 'font-style', 'italic'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Web Developer'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('August 2015 - Present'),
													_1: {
														ctor: '::',
														_0: A2(
															_elm_lang$html$Html$ul,
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$style(_rychan14$resume$App$bulletPoint),
																_1: {ctor: '[]'}
															},
															{
																ctor: '::',
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('Working with various major clients as a Front-end JavaScript developer'),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('Rebuilt frontend of Qualcomm.com using ReactJS and Redux'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html$text('Built frontend for MazdaUSA.com using custom JavaScript framework'),
																				_1: {ctor: '[]'}
																			}),
																		_1: {ctor: '[]'}
																	}
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('BofI Federal Bank, '),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										...
										_1: {
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('September 2014 - August 2015'),
														_1: {
															ctor: '::',
															_0: A2(
																_elm_lang$html$Html$ul,
																...
																},
																{
																	...
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('Migrated 100s of pages of web content from Sitefinity CMS to DNN'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html$text('Worked mostly with jQuery, JavaScript, HTML, and CSS to rebuild UI'),
																				_1: {ctor: '[]'}
																			}),
																		_1: {
																			ctor: '::',
																			_0: A2(
																				...
																				{
																					ctor: '::',
																					_0: _elm_lang$html$Html$text('Built Python scripts to extract and migrate web content, using Scrapy'),
																					_1: {ctor: '[]'}
																				}),
																			_1: {
																				ctor: '::',
																				_0: A2(
																					...
																					{
																						ctor: '::',
																						_0: _elm_lang$html$Html$text('Assisted in production deployments and SQL database merges'),
																						_1: {ctor: '[]'}
																					}),
																				_1: {
																					ctor: '::',
																					_0: A2(
																						...
																						{
																							ctor: '::',
																							_0: _elm_lang$html$Html$text('Managed Dev, QA, Stage, and Production environments'),
																							_1: {ctor: '[]'}
																						}),
																					_1: {ctor: '[]'}
																				}
...
var _rychan14$resume$App$expertiseSection = function (model) {
	return A2(
		_elm_lang$html$Html$section,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$h2,
				{
					...
					_0: function (_p5) {
						return _elm_lang$html$Html_Attributes$style(
							_rychan14$resume$App$sectionTitle(_p5));
					}(model),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Expertise'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('In-depth experience with JavaScript, specifically with ES2015-2017, ReactJS, and SASS'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Extensive knowledge of CSS, including SASS, CSS animations, media queries, flexbox and grid layouts'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Accustomed to developing in the Agile workflow with daily scrums and sprints and working in cross-functional teams in highly collaborative environments'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Tools such as Git and BitBucket for source control management'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Debugging and cross browser testing'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
...
var _rychan14$resume$App$educationSection = function (model) {
	return A2(
		_elm_lang$html$Html$section,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$h2,
				{
					...
					_0: function (_p6) {
						return _elm_lang$html$Html_Attributes$style(
							_rychan14$resume$App$sectionTitle(_p6));
					}(model),
					_1: {ctor: '[]'}
				},
				{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(_rychan14$resume$App$boldText),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('University of California, San Diego'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Cognitive Science, with specialization in Computation; B.S'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
...
var _rychan14$resume$App$Tertiary = {ctor: 'Tertiary'};
var _rychan14$resume$App$leftBar = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_rychan14$resume$App_ops['=>'], 'border-right', '1px solid '),
					_1: {
						ctor: '::',
						_0: A2(
							_rychan14$resume$App_ops['=>'],
							'border-color',
							A2(_rychan14$resume$App$theming, model, _rychan14$resume$App$Tertiary)),
						_1: {
							ctor: '::',
							_0: A2(_rychan14$resume$App_ops['=>'], 'display', 'flex'),
							_1: {
								ctor: '::',
								_0: A2(_rychan14$resume$App_ops['=>'], 'justify-content', 'center'),
								_1: {
									ctor: '::',
									_0: A2(_rychan14$resume$App_ops['=>'], 'padding', '35px 8px'),
									_1: {
										ctor: '::',
										_0: A2(_rychan14$resume$App_ops['=>'], 'overflow-wrap', 'break-word'),
										_1: {ctor: '[]'}
									}
								}
							}
			...
			_0: A2(
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_1: {
								ctor: '::',
								_0: A2(_rychan14$resume$App_ops['=>'], 'flex-flow', 'column'),
								_1: {
									ctor: '::',
									_0: A2(_rychan14$resume$App_ops['=>'], 'max-width', '100%'),
									_1: {ctor: '[]'}
								}
							}
						}),
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$style(_rychan14$resume$App$inlineBlock),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _rychan14$resume$App$Secondary = {ctor: 'Secondary'};
var _rychan14$resume$App$Primary = {ctor: 'Primary'};
var _rychan14$resume$App$buttonStyle = function (themeType) {
	return {
		ctor: '::',
		_0: A2(
			_rychan14$resume$App_ops['=>'],
			'background-color',
			A2(_rychan14$resume$App$buttonTheming, themeType, _rychan14$resume$App$Primary)),
		_1: {
			ctor: '::',
			_0: A2(_rychan14$resume$App_ops['=>'], 'border', '1px solid'),
			_1: {
				ctor: '::',
				_0: A2(
					_rychan14$resume$App_ops['=>'],
					'border-color',
					A2(_rychan14$resume$App$buttonTheming, themeType, _rychan14$resume$App$Title)),
				_1: {
					ctor: '::',
					_0: A2(_rychan14$resume$App_ops['=>'], 'border-radius', '3px'),
					_1: {
						ctor: '::',
						_0: A2(
							_rychan14$resume$App_ops['=>'],
						...
						_1: {
							ctor: '::',
							_0: A2(_rychan14$resume$App_ops['=>'], 'cursor', 'pointer'),
							_1: {
								ctor: '::',
								_0: A2(_rychan14$resume$App_ops['=>'], 'display', 'inline-block'),
								_1: {
									ctor: '::',
									_0: A2(_rychan14$resume$App_ops['=>'], 'padding', '5px 10px'),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _rychan14$resume$App$themeButton = function (themeType) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				_rychan14$resume$App$buttonStyle(themeType)),
			_1: {
				ctor: '::',
				_0: function (_p7) {
					return _elm_lang$html$Html_Events$onClick(
						_rychan14$resume$App$ThemeMsg(_p7));
				}(
					_elm_lang$core$String$toLower(themeType)),
				_1: {ctor: '[]'}
			}
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(themeType),
			_1: {ctor: '[]'}
		});
};
var _rychan14$resume$App$buttonContainer = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(_rychan14$resume$App$buttonContainerStyle),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _rychan14$resume$App$themeButton('Light'),
			_1: {
				ctor: '::',
				_0: _rychan14$resume$App$themeButton('Dark'),
				_1: {ctor: '[]'}
			}
		});
};
var _rychan14$resume$App$resumeView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_rychan14$resume$App_ops['=>'], 'font-size', '14px'),
					_1: {
						ctor: '::',
						_0: A2(_rychan14$resume$App_ops['=>'], 'padding', '0 30px'),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
		...
		{
			ctor: '::',
			_0: _rychan14$resume$App$nameSection(model),
			_1: {
				ctor: '::',
				_0: _rychan14$resume$App$experienceSection(model),
				_1: {
					ctor: '::',
					_0: _rychan14$resume$App$expertiseSection(model),
					_1: {
						ctor: '::',
						_0: _rychan14$resume$App$educationSection(model),
						_1: {
							ctor: '::',
							_0: _rychan14$resume$App$buttonContainer(model),
							_1: {ctor: '[]'}
						}
					}
				}
	...
	return A2(
		...
		A3(
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_0: A2(
								_rychan14$resume$App_ops['=>'],
								'color',
								A2(_rychan14$resume$App$theming, model, _rychan14$resume$App$Text)),
							_1: {
								ctor: '::',
								_0: A2(_rychan14$resume$App_ops['=>'], 'font-family', 'Verdana'),
								_1: {
									ctor: '::',
									_0: A2(_rychan14$resume$App_ops['=>'], 'display', 'grid'),
									_1: {
										ctor: '::',
										_0: A2(_rychan14$resume$App_ops['=>'], 'grid-template-columns', '15% minmax(auto, 800px)'),
										_1: {
											ctor: '::',
											_0: A2(_rychan14$resume$App_ops['=>'], 'min-height', '100vh'),
											_1: {
												ctor: '::',
												_0: A2(_rychan14$resume$App_ops['=>'], 'padding', '20px'),
												_1: {ctor: '[]'}
											}
										}
									}
			...
			_elm_lang$core$List$concat(
				{
					ctor: '::',
					_0: _mdgriffith$elm_style_animation$Animation$render(model.style),
					_1: {
						ctor: '::',
						_0: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$style(
								{
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: A2(_rychan14$resume$App_ops['=>'], 'padding', '5px'),
												_1: {ctor: '[]'}
											}
										}
									}
		...
		A3(
			...
			{
				ctor: '::',
				_0: _rychan14$resume$App$leftBar(model),
				_1: {
					ctor: '::',
					_0: _rychan14$resume$App$resumeView(model),
					_1: {ctor: '[]'}
				}
			},
			{
...
var Elm = {};
Elm['App'] = Elm['App'] || {};
if (typeof _rychan14$resume$App$main !== 'undefined') {
    _rychan14$resume$App$main(Elm['App'], 'App', undefined);
}
